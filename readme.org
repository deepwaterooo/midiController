...
- on 4/7/2015's update, I was supposed to manually resolve conflicts, but I was not aware the problem enough to pay attention to it, ended up by having made three commits; (the readme.org 
<<<<<<< HEAD
 * updates 4/7/2015
 ** updates
...
- And last week Tuesday's update I had been blocked by some time becuase of a >100MB pdf file, could use git rm --cached filename;
- Added a dev branch. After having spent couple of hours on it, git branches are well-designed easily-understood theories, 
