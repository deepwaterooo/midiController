...
- Still lots of work to do, slot functiona about phonon player, and midi read/write, and potentially more as well to make it responsive. Will put more effort on this project for the following several weeks.
* update 4/18/2015
