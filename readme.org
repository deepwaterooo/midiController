...
* update 5/18/2015, Monday
** Project
- Didn't start this project this semester until 2/12/2015, which was ONE month after spring semester started already, and for the frist week, it was just a catch up, didn't really do anything (which made it *five week late*....);
- This project was targeted last through out the summer section till graduation. And that's the reason the weekly meeting has been cancelled for 3/3, 3/17, 3/24, 3/31, 4/14 (which made it *five week less*....). And for the most of the meetings that we physically meet in CSAC, the meeting usually lasted for about half an hour (which made *half potential promoting time gone*....). 
- This is a lonely learning process, NO classmates/teammates to discuss with, NO mentor/friends aside to guide/teach/inspire, NO admirable instuctor to offer any constructive suggestions. This project was designed to be a war against me, a war that I suffered from, and a war of my own fighting against myself.... 
- Together with the university *chicken-smell culture*, campus food court most hard labor work ever, this spring semester, for me, has been *horrific and lasted a century....* Which also made the excellent mentor-intern experience especially memorable even it lasted only one month, recalled when my life currently suffers. 
- I have suffered enough from here from current university designed by all the jerks, and *I would NEVER want to come back here ever again!*
** Other
*** study plan
- The *study plan* still has one course listed which I don't need and I have turned in "*change of study plan*" form to remove it and got approved by the advisor, but it IS still there today after three rounds of modifications. Will take all the effort to remove it by meeting the professionals this afternoon (within these two days).
  - Went to the registar office, get the root cause, and sent out application and email to advisor with HIGH importance again. 
  - Up to 5:00pm today, the advisor has NOT approved the changes yet. (The advisor has approved adding cs499 on May 13 chagnes -- the second round. And the advisor agreed that the one course exist in my study plan which I never took before is NOT necessary. So I will just audit this "approving" process through here or other repository.)
*** student account
- Check my student account balance (need pay $25 application for graduation fee), and clear out my student account, so that I will NOT own any cent from the university.
  - the $25 graduation fee has NOT applied to my student account yet even I filled online applied for graduation already. They asked me to wait until it is applied into my account.
*** clear project out
- Discuss with the advisor what he wants me do next, and if I have to carry the device and/or books with me, how to return these stuff back to him without I revisit the university personally physically. 
  - Considering the teaching and studying skills the instructor and the student have, the advisor concluded that all the work I have done worth a graduate project already (even though I don't think it counter equivals a cs210 Tic-Tac-Toe hw2, which has helped build great confidence for me.)
  - The advisor asked for and copied the zipped codes I have so far away, asked the midi device back. Having NOT prepared for this, *I will return one midi-related book and midi connection core to him or to main office his mail box tomorrow.*
  - As I have descripted the learning process for this project already, when the project is declared done, I have suffered and been a robot for a long time that I can NOT feel anything at all. It was a meaningless plain poor learning process. 
** Study Plan emails - make it LAST round!
*** email sent out after having applied "change of study plan" form
- Status of changes to study plan 'Oct 3, 2009'

degreeaudit@uXXXX.edu [degreeaudit@uXXXX.edu]
...
The changes requested for your University of XXXX study plan 'Oct 3, 2009' are now being forwarded to your major professor, (advisor~), for review.

If (advisor~) is not your major professor, please fill out the Appointment of Major Professor Form, available on the College of Graduate Studies website, and resubmit this request after your record is updated. Confirmation of the appointment can be viewed on the VandalWeb Check Registration Status page.

Thank you.

- Status of changes to study plan 'May 15 2015'
...
The changes requested for your University of XXXX study plan 'May 15 2015' are now being forwarded to your major professor, (advisor~), for review.

If (advisor~) is not your major professor, please fill out the Appointment of Major Professor Form, available on the College of Graduate Studies website, and resubmit this request after your record is updated. Confirmation of the appointment can be viewed on the VandalWeb Check Registration Status page.

Thank you.
*** email write to advisor for processing faster
...
To:	advisor@uxxxx.com

Dr. advisor, 

The university web system sucks and the emails sent out when we made modifications to study plan, the emails don't include any course related information at all. So even I deleted the cs5XX course once on 5/13/2015 already, they just ignored it and didn't make any changes for me for this course at all. 

So today, checked by two female stuff from the registrar office together, I have deleted cs5XX once again, and added cs499 Android app programming, which you have approved already for cs499. But for the university's sucks web systems' sake, please help me approve it once again. And this time, it was just ONE email sent out 3:23pm TODAY. I would want to get this "study plan" fixed before I leave for CA. Please help me approve it as soon as possible!

thanks in advance. 

(me~)

Notes: 5XX was writen here for my own privacy, but the email sent to advisor is clearly stated. 
** repository updates
- I would NOT focus and update this repository for a while, but will for sure maintain *MyAutobiography & MyAlgorithms* continuously consistently. 
** Go to hell~
- Still, one more sentence, I know there is a song called “God bless American”. I would have to say may God bless all the jerks go to hell~ When they were about to die, may God remind them to remember that years ago there was a international student blessed them all go to hell~ Reasons made me saying this could be found at https://github.com/deepwaterooo/MyAutobiography.

* update 5/17/2015
- It's NOT necessary to separate the player into a separate thread, because QWidget subfamilies are NOT thread safe, I will still keep the phonon-related functions in the mainwindow main GUI, just separate the checking midi port tasks into a separate thread.
- checkout an old version of commits, and continue to remove the unnecessary menu bar, and musictable, together with fix the bugs....
- deleted some unnecessary codes to remove menubar & musicTable;
- modified timeLcd to display total time as well, referring to advisor's rule that "the more information the better".
- may work on make upper-leffer corner buttons look slightly better than current now....
* update 5/15/2015
- The advisor met his other student instead, meeting got rescheduled to be on coming Monday. 
- I applied for graduation on time before 5/12/2015, right now I am still WAITING for department of Engineering to approve for my study plan. 
- The Study Plan was finally approved by College of Graduate Studies, will be waiting for the Office of the Rigistrar to continue updates. 
- But after busy contacting these days, I still failed to figure out how to remove the unnecessary one course from my Degree Audit "Study Plan Detail" list. The personile was going home, and having Monday off, so I could only get my Study Plan eventually fixed earliest by coming Tuesday, if things goes smoothly~!
 
* update 5/11/2015, Monday
- Realized that except that the thread checking midi port run() is running in a separate thread, all others are still within the GUI main thread
  - The bottom layer user reconfiguration section has limited steps and executed fast, produce barely noticable block, doesn't affect by thread that much.
  - But the phonon median player, I think if I could separate it into an independend thread, and then communicate with other thread, this multi-threads design should significantly improve the GUI responsiveness and user experience. 
  - I needs high-level architecture design, but feels like the advisor barely offer help for me from this perspective. 
  - Will discuss with the advisor today to see his ideas. 
- Project handling related thinking
  - This project has lasted too long already, but I have never be any person that tend to be late and delay, examples include I was top 2 student who successfully accomplished the Tic-Tac-Toe one-best-move-step lisp hw2 program (according to certain criterion) for CS210 (Programming Language) within my first month of new major study (*Sep 18, 2012*, the course instructor delayed the due time for 1 day because majority of the class has no clue where to start). The reasons that I am late now for this project includes: 
    - Ever since RTOS (Real Time Operating System course), I began to realize that this advisor is NOT that into programming, as well as has some difficulty to explain concepts clear. And for courses after courses, as cs is a new major for me, I have suffered from this, and I had NEVER have enough confidence in the course instuctor, and my performance was significantly affected by this.
    - From my side, as an international student, I also have difficulty in understanding concepts, and have slightly foreighn language related affects. 
    - For my education and project experience, it's more like with a great mentor or team member, I performs great; On the other hand, if the environment doesn't help, I become a poor guy with barely any production....
    - This project experience for me, is like my personal learning how to swim process after having been drowned almost to death when I was a kid. The whole process feels lonely and helpless, and I have to stuggle my own way out, which always made me rewind the internship season when a experienced mentor could always help test the knowledge points (for example, the first time repack my program into modules so that my programs could be reusable, python sys.path.append("....") https://github.com/deepwaterooo/MyAutobiography *part2\textunderscore deepwaterooo-Autobiography.pdf* section 8.29 实习(26) 8.30 实习(27) *page 48 & 49*)
- Review and Project Remaaining problems
  - The advisor concludes that the project is *petty much there* 
  - Midi LED ON/OFF is NOT as responsive as we expected. 
    - I have used ./midi_read_write/midi_usb_write_onteOnOff.cpp single program to test midi device LED ON/OFF as well, the performance is NOT stable.
    - The advisor suggested mutex protection for shared data write. So I have tried adding those mutex lock() unlock() back, but it doesn't seem to help at all. 
    - The advisor concludes that it could be my programs-related reasons, could be midi device issues, and could also be midi-usb software problems.
  - Following:
    - I am not that into midi LED ON/OFF responsiveness issues, but would rather pack my programs so that it has more thread and performs more responsive than it is right now. Considering all the work I have done already, the advisor agreed. 
    - I will continuously work from today to Thursday 2-9 pm, but still scheduled a potential meeting time with advisor on *coming Friday, 5/15/2015 1pm* expecting to make some progress on threads communications.
- Other graduation related: the university *web system* made a mess with my study plan, they are working on it to remove one couse in my study plan, which I have never added it into my study plan. There is no reason it should NOT process well. 

* update 5/9/2015
- look into error msgs:
  - (midiUI:5544): Gtk-CRITICAL **: IA\textunderscore \textunderscore gtk\textunderscore widget\textunderscore get\textunderscore direction: assertion 'GTK\textunderscore IS\textunderscore WIDGET (widget)' failed
    - QObjects constructed without parent are owned by Qt instead of PyQt, this error is probably a result of the destructor being called twice when exiting.
    - Not completely fixed yet.
  - GStreamer-CRITICAL **: gst\textunderscore pad\textunderscore link\textunderscore full: assertion 'GST\textunderscore IS\textunderscore PAD (sinkpad)' failed

* update 5/8/2015
- add a configure file for latest user configuration for key-song bindings.
- add a QFile read/write utility class. Default loading, user re-configuration, save to default are all fully functional for the bottom section now.
- connected 33 "Browse" buttons with the 33 QPlainTextEdit editors through QSignalMapper, which I had applied similar connections one-by-one for Senior design for last semester!
- Upper section Midi LED ON/OFF still needs focus and some work, will spend some hours continuously on it tomorrow.
- Remove menubar and musicTable is the easiest thing to do, temporatorily keep them for debugging propose only.
...
- Continued with the project up to this point, my feeling was complicated, felt so sorry for the years I have spent here. will write them into words and update them after the review. 
  - About three years ago in *Aug 2012*, when I have planed to go back to china (if I can select only *7 credits* for the first semester with *cs120 B* as the only background), the ex-advisor and the famous professor from the department made me stay by giving me permission to select more credits;
  - The famous professor from the department made me walk around many important courses, like algorithms, software engineering etc, without giving me any course opportunity to build any solid background, like kicked me off from cs480 so that I don't have to take cs481 for Spring 2015, such that they -- the department doesn't have to give me a TA for the spring semester after I have paid self-supported tuition fees continuously for three semesters ... After five semesters hard work and good performance, eventually I still have to do labor work to make a living here on campus ....
  - The famous professor from the department designed the uncooperate character for me by having asked me to change advisor when we don't have much conflicts at that time yet... I have worked in the same company in 2010 and 2011 for Nielson Online twice. Cooperative or Uncooperative, it has been more a policy or U.S.A. culture towards me now instead of my own character/personality !
  - It's painful to rewind back all these bad memory and details. I will continuously update this part later when I get my mind back systematically. 
...
- 串口通讯 http://mobile.51cto.com/symbian-270754.htm
