...
- This project was targeted last through out the summer section till graduation. And that's the reason the weekly meeting has been cancelled for 3/3, 3/17, 3/24, 3/31, 4/14 (which made it *five week less*....). And for the most of the meetings that we physically meet in CSAC, the meeting usually lasted for about half an hour (which made *half promoting time gone*....). 
