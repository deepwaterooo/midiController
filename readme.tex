...
\label{sec-1}
\begin{itemize}
\item on 4/7/2015's update, I was supposed to manually resolve conflicts, but I was not aware the problem enough to pay attention to it, ended up by having made three commits; (the readme.org
\end{itemize}
<<<<<<< HEAD
\begin{itemize}
\item updates 4/7/2015
\end{itemize}
** updates
\begin{itemize}
...
\begin{itemize}
\item And last week Tuesday's update I had been blocked by some time becuase of a >100MB pdf file, could use git rm --cached filename;
\item Added a dev branch. After having spent couple of hours on it, git branches are well-designed easily-understood theories,
\end{itemize}
...
\item ´®¿ÚÍ¨Ñ¶ \url{http://mobile.51cto.com/symbian-270754.htm}
