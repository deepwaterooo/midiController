...
\section{update 5/18/2015, Monday}
\label{sec-1}
\subsection{Project}
\label{sec-1-1}
\begin{itemize}
\item Didn't start this project this semester until 2/12/2015, which was ONE month after spring semester started already, and for the frist week, it was just a catch up, didn't really do anything (which made it \textbf{five week late}\ldots{}.);
\item This project was targeted last through out the summer section till graduation. And that's the reason the weekly meeting has been cancelled for 3/3, 3/17, 3/24, 3/31, 4/14 (which made it \textbf{five week less}\ldots{}.). And for the most of the meetings that we physically meet in CSAC, the meeting usually lasted for about half an hour (which made \textbf{half potential promoting time gone}\ldots{}.).
\item This is a lonely learning process, NO classmates/teammates to discuss with, NO mentor/friends aside to guide/teach/inspire, NO admirable instuctor to offer any constructive suggestions. This project was designed to be a war against me, a war that I suffered from, and a war of my own fighting against myself\ldots{}.
\item Together with the university \textbf{chicken-smell culture}, campus food court most hard labor work ever, this spring semester, for me, has been \textbf{horrific and lasted a century\ldots{}.} Which also made the excellent mentor-intern experience especially memorable even it lasted only one month, recalled when my life currently suffers.
\item I have suffered enough from here from current university designed by all the jerks, and \textbf{I would NEVER want to come back here ever again!}
\end{itemize}
\subsection{Other}
\label{sec-1-2}
...
\label{sec-1-2-1}
\begin{itemize}
\item The \textbf{study plan} still has one course listed which I don't need and I have turned in "\textbf{change of study plan}" form to remove it and got approved by the advisor, but it IS still there today after three rounds of modifications. Will take all the effort to remove it by meeting the professionals this afternoon (within these two days).
\begin{itemize}
\item Went to the registar office, get the root cause, and sent out application and email to advisor with HIGH importance again.
\item Up to 5:00pm today, the advisor has NOT approved the changes yet. (The advisor has approved adding cs499 on May 13 chagnes -- the second round. And the advisor agreed that the one course exist in my study plan which I never took before is NOT necessary. So I will just audit this "approving" process through here or other repository.)
\end{itemize}
\end{itemize}
\subsubsection{student account}
\label{sec-1-2-2}
\begin{itemize}
\item Check my student account balance (need pay \$25 application for graduation fee), and clear out my student account, so that I will NOT own any cent from the university.
\begin{itemize}
\item the \$25 graduation fee has NOT applied to my student account yet even I filled online applied for graduation already. They asked me to wait until it is applied into my account.
\end{itemize}
\end{itemize}
\subsubsection{clear project out}
\label{sec-1-2-3}
\begin{itemize}
\item Discuss with the advisor what he wants me do next, and if I have to carry the device and/or books with me, how to return these stuff back to him without I revisit the university personally physically. 
\begin{itemize}
\item Considering the teaching and studying skills the instructor and the student have, the advisor concluded that all the work I have done worth a graduate project already (even though I don't think it counter equivals a cs210 Tic-Tac-Toe hw2, which has helped build great confidence for me.)
\item The advisor asked for and copied the zipped codes I have so far away, asked the midi device back. Having NOT prepared for this, \textbf{I will return one midi-related book and midi connection core to him or to main office his mail box tomorrow.}
\item As I have descripted the learning process for this project already, when the project is declared done, I have suffered and been a robot for a long time that I can NOT feel anything at all. It was a meaningless plain poor learning process.
\end{itemize}
\end{itemize}
\subsection{Study Plan emails - make it LAST round!}
\label{sec-1-3}
\subsubsection{email sent out after having applied "change of study plan" form}
\label{sec-1-3-1}
\begin{itemize}
\item Status of changes to study plan 'Oct 3, 2009'
\end{itemize}
...
To:        (Me\textasciitilde{}) ((me\textasciitilde{})@uXXXX.edu)

Dear (Me\textasciitilde{}),

The changes requested for your University of XXXX study plan 'Oct 3, 2009' are now being forwarded to your major professor, (advisor\textasciitilde{}), for review.

If (advisor\textasciitilde{}) is not your major professor, please fill out the Appointment of Major Professor Form, available on the College of Graduate Studies website, and resubmit this request after your record is updated. Confirmation of the appointment can be viewed on the VandalWeb Check Registration Status page.

Thank you.

\begin{itemize}
\item Status of changes to study plan 'May 15 2015'
\end{itemize}
...
The changes requested for your University of XXXX study plan 'May 15 2015' are now being forwarded to your major professor, (advisor\textasciitilde{}), for review.

If (advisor\textasciitilde{}) is not your major professor, please fill out the Appointment of Major Professor Form, available on the College of Graduate Studies website, and resubmit this request after your record is updated. Confirmation of the appointment can be viewed on the VandalWeb Check Registration Status page.

Thank you.
\subsubsection{email write to advisor for processing faster}
\label{sec-1-3-2}
RE: MS CS Study Plan \_ from (me\textasciitilde{}) 
...
\label{sec-1-4}
\begin{itemize}
\item I would NOT focus and update this repository for a while, but will for sure maintain \textbf{MyAutobiography \& MyAlgorithms} continuously consistently.
\end{itemize}
\subsection{Go to hell\textasciitilde{}}
\label{sec-1-5}
\begin{itemize}
\item Still, one more sentence, I know there is a song called “God bless American”. I would have to say may God bless all the jerks go to hell\textasciitilde{} When they were about to die, may God remind them to remember that years ago there was a international student blessed them all go to hell\textasciitilde{} Reasons made me saying this could be found at \url{https://github.com/deepwaterooo/MyAutobiography}.
\end{itemize}
...
\item 串口通讯 \url{http://mobile.51cto.com/symbian-270754.htm}
