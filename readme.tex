...
\label{sec-1-2}
\begin{itemize}
\item Need to schedule a time this week ask the advisor to help review "Study Plan", so that I can apply for graduation and get graduated as planed.
\end{itemize}
